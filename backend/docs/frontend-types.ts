 ...
 * Compatible with TypeScript 4.5+ and Next.js / Vite React applications.
 */
...
export interface Farm {
  ...
  crop_profile?: Record<string, any> | null;
...
export interface FarmMembershipCreate {
  user_id: string;
  role: FarmRole | string;
}
...
// ==========================================
// 6. EXTERNAL OBSERVATIONS (WEATHER / SATELLITE / MARKET)
// ==========================================
...
export interface RiskAssessment {
  ...
  score: number;
  confidence: number;
  evidence?: RiskEvidence | Record<string, any> | null;
...
export interface RiskAssessmentEvaluateRequest {
  farm_id: string;
  zone_id?: string | null;
  telemetry_override?: Record<string, any> | null;
}
...
export interface ActionPlanCreate {
  ...
  source?: "ai_agent" | "user" | "rule_engine" | string;
  ai_proposal?: AIProposal | null;
}

export interface ActionPlanApprovalRequest {
...
export interface ActionPlan {
  ...
  safety_notes?: string | null;
  steps?: ActionPlanStep[] | Record<string, any>[] | null;
  source?: string | null;
  rationale?: string | null;
  version: number;
  created_at: string; // ISO-8601
...
export interface DemoRunResult {
  ...
  telemetry_measurements: Record<string, any>;
  risk_id?: string | null;
  risk_type?: string | null;
  risk_severity?: string | null;
  risk_score?: number | null;
  ai_proposal?: Record<string, any> | null;
